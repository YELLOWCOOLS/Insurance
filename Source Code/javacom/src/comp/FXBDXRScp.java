...
public class FXBDXRScp extends Cpimpl implements Cp{
	...
	public FXBDXRScp() {
		...
		//一个开始对应一个结束
		Zhongjistart = new String[]{"10.  重大疾病定义|13.  重大疾病定义|10.  重大疾病定义|9.  重大疾病定义|11.  重大疾病定义"};
		Zhongjiend = new String[]{"11. 释义|14.  术语释义|11.  术语释义|10.  术语释义|12.  术语释义"};
			...
			case 7:
				do {
					...
					if (ma1.find()&&!p1G.matcher(line).find()) {
						...
						name.append(line.replaceAll("[0-9]+\\.[0-9]+","").trim());

...
public class JXRScp extends Cpimpl implements Cp{
	...
	public JXRScp() {
		...
		//一个开始对应一个结束
		Zhongjistart = new String[]{"第二十七条       重大疾病的种类和定义|第十八条      重大疾病的种类及定义|第二十一条       重大疾病的种类和定义|第十八条      重大疾病的种类及定义 |重大疾病的种类及定义|重大疾病的种类和定义"};
		Zhongjiend = new String[]{"第三十条      释义|吉祥人寿附加学生儿童重大疾病保险（2017版）条款|第二十三条       适用主合同条款|吉祥人寿附加学生儿童重大疾病保险条款（第8页）|第二十七条       年龄计算及错误处理|第二十四条       年龄计算及错误处理|第二十二条       年龄计算及错误处理|第二十四条       适用主合同条款|吉祥人寿附加学生儿童重大疾病保险条款（第8页）|第二十六条       年龄计算及错误处理|第二十三条       适用主合同条款 "};

...
public class PAYLcp extends Cpimpl implements Cp{
	...
	public PAYLcp() {
		...
		//一个开始对应一个结束
		Zhongjistart = new String[]{"【基本重大疾病】|【重大疾病】"};
		Zhongjiend = new String[]{"【意外事故】|【毒品】"};
...
//					}
					...
					if (ma1.find()) {
						...
						String results[] = line.split("[ ]{2,}");
						//String rest[] = results[1].trim().split("[ ]{2,}");
						name.append(results[2].trim().replaceAll("\\s+",""));

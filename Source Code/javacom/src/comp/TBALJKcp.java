...
public class TBALJKcp extends Cpimpl implements Cp{
	...
	public TBALJKcp() {
		...
		//一个开始对应一个结束
		Zhongjistart = new String[]{"4．       重大疾病的定义|4.1      重大疾病"};
		Zhongjiend = new String[]{"4.2      定义来源及确|4.2      定义来源"};
...
//				continue;
			...
			if (Pattern.compile("1．\\s+基本条款").matcher(line).find()) {
				nameflag = flag = false;
				inf += 1000;
				break;
			}

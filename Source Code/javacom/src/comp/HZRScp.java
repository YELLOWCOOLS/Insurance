...
public class HZRScp extends Cpimpl implements Cp{
	...
	public HZRScp() {
		...
		//一个开始对应一个结束
		Zhongjistart = new String[]{"6.4     轻症疾病|6.4      特定疾病|6.4    少儿重大疾病|6.4   少儿重大疾病|6.4      少儿重大疾病|7.2    重大疾病|6.3   重大疾病|6.5      重大疾病|6.2     重大疾病|6.4     少儿重大疾病|6.4      重大疾病|6.4      A 组重大疾病|6.4     重大疾病|6.5     少儿重大疾病|6.4      少儿重大疾病    "};
		Zhongjiend = new String[]{"6.6    意外伤害|6.8      意外伤害|6.5    意外伤害|6.7    意外伤害|6.6   意外伤害|6.6   意外伤害|7.3    意外伤害|6.4   意外伤害|6.6      意外伤害|6.3     意外伤害|6.6     意外伤害|6.5      意外伤害|6.7      意外伤害|6.5     意外伤害|6.7     全残 |6.6      意外伤害"};
...
//				break;
				...
				do {
					...
					if (ma1.find()) {
						...
						if(line.length()>25&&!p2.matcher(line.substring(0, 25)).find()) {
							nameflag=false;
							}else {
								nameflag=true;
							}
						...
						if(p1D1.matcher(line).find())
							...
							if(line.length()>15&&!p2.matcher(line.substring(0, 15)).find()) {
								...
								ma1 = p2.matcher(line.substring(0, 25));
								if (ma1.find() && nameflag) {
									String tmps[] = line.split("[ ]{2,}");

...
public class GHRScp extends Cpimpl implements Cp{
	...
	public GHRScp() {
		...
		//一个开始对应一个结束
		Zhongjistart = new String[]{"7.7   少儿重大疾病|7.9   成人重大疾病|7.4   重大疾病|9.7     重大疾病|9.7     重大疾病|9.5     重大疾病|9.5     重大疾病|8.5      重大疾病|8.5    重大疾病|8.4   少儿重大疾病|8.6   少儿重大疾病|7.4   少儿重大疾病 |8.5    少儿重大疾病|8.5     重大疾病|8.8        重大疾病|8.5   重大疾病|7.8   现金价值|8.3   成人重大疾病|8.5   成人重大疾病|8.5   成人重大疾病|8.5   少儿重大疾病|8.5   少儿重大疾病|8.5   少儿重大疾病"};
		Zhongjiend = new String[]{"7.8   现金价值|7.10  毒品|7.5   初次发生|9.8     轻症疾病|9.9     初次发生|9.8     初次发生|9.7     初次发生|9.6     初次发生|8.6      初次发生|8.6    初次发生|8.5   初次发生|8.9   初次发生|上述   7.4 至 7.5 的释义中部分术语释义如下：|上述   8.5 至 8.8 的释义中部分术语释义如下：|8.6     现金价值|8.9        医院|上述   8.5 的释义中部分术语释义如下：|7.10  毒品|8.5   初次发生|8.7   初次发生|8.7   现金价值|8.7   现金价值|8.9   现金价值|8.8   现金价值"};
	...
	public int Zhongjiprocess(BufferedReader br) throws IOException {
		...
		if (line == null) {
			...
			int plan = -1;
			while ((line = br.readLine()) != null) {
				if(Pattern.compile("三大关节|永久不可逆|六项基本日常生活活动|8.10   特定疾病|8.9    重大疾病|一、《重大疾病保险的疾病定义使用规范》范围以内的疾病种类").matcher(line).find()) {
					continue;
				}

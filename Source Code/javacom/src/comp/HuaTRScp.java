...
public class HuaTRScp extends Cpimpl implements Cp{
	...
	public HuaTRScp() {
		...
		//一个开始对应一个结束
		Zhongjistart = new String[]{"7.6    重大疾病|3.  重大疾病：|7.7   轻型重疾|9.8    轻型疾病|8.8    轻型疾病|10.8  重大疾病|3.   重大疾病：|10 .5  重大  疾病|7.7    轻型重疾|10.5   癌症|10.5   重大疾病|7.5    重大疾病|4.  重大疾病：|6.5    重大疾病|7.3    重大疾病"};
		Zhongjiend = new String[]{"4.  意外伤害事故：|7.10  毒品|9.11    《人身保险|8.11   酒后驾驶|10.10 自主生活|7.6   意外伤害事故|4.   意外伤害事故：|10.6   自主生活|7.10   毒品|10.13  贷款利率|10.6   自主生活|7.6    毒品|5.  意外伤害事故：|7.4    医院|7.6    意外伤害事故|6.6．   意外伤害事故         指遭受|7.4    医院"};
	...
	public int Zhongjiprocess(BufferedReader br) throws IOException {
		...
		Pattern p1I = Pattern.compile("^[ ]{0,40}+[0-9]+）");
		...
		if (line == null) {
			...
			int plan = -1;
			while ((line = br.readLine()) != null) {
				if(Pattern.compile("8.10+[ ]{0,}+特定疾病|8.9+[ ]{0,}+重大疾病|一、《重大疾病保险的疾病定义使用规范》范围以内的疾病种类").matcher(line).find()) {
					continue;
				}

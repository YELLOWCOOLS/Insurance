...
public class TARScp extends Cpimpl implements Cp{
	...
	public TARScp() {
		...
		//一个开始对应一个结束
		Zhongjistart = new String[]{"5.5      本合同所|6.6      本合同所| 5.4      本合同所|6.7     本合同约|本合同所指的重大疾病，是指符合下列定义的疾病|6.4     本合同所指|恶性肿瘤："};
		Zhongjiend = new String[]{"5.21     指定鉴定|6.19     指定鉴定|艾滋病。|5.5      意外伤害|6.8     意外伤害|5.5     本合同所|第十七条     一般释义|6.6     本保险实际|6.5     本保险|保单欠款："};

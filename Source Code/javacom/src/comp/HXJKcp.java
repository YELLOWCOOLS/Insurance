...
public class HXJKcp extends Cpimpl implements Cp{
	...
	public HXJKcp() {
		...
		Mulustart = "条款是保险合同的重要内容";
		Muluend ="和谐健康";
		//此处设置为数组  表示重疾所在的段落可能不在 一个地方
		//一个开始对应一个结束
		Zhongjistart = new String[]{"7.7       重大疾病|7.5  重大疾病|7.7    重大疾病|7.2     重大疾病|6.4    重大疾病|6.4   重大疾病|7.5   重大疾病|7.4   重大疾病"};
		Zhongjiend = new String[]{"7.8       意外伤害|7.6  意外伤害|7.8    意外伤害|7.3     专科医生|6.5    意外伤害|6.5   意外伤害|7.6   意外伤害|7.5   意外伤害"};
			...
			case 0:
				...
				do {
					...
					if (ma1.find()) {
						...
						String resultss[] = results[1].trim().split("[ ]+");

...
public class GLRScp extends Cpimpl implements Cp{
	...
	public GLRScp() {
		...
		//一个开始对应一个结束
		Zhongjistart = new String[]{"7.1     重大疾病的范围|7.1    重大疾病的范围|8.2     重大疾病的范围|7.2     重大疾病的范围"};
		Zhongjiend = new String[]{"8．      释义 |7.2    特定疾病的范围|9．      释义|8．      释义"};

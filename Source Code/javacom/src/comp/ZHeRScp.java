...
public class ZHeRScp extends Cpimpl implements Cp {
		...
		Mulustart = "条[ ]*款[ ]*目[ ]*录 ";
		Muluend ="^[ ]*条[ ]*款[ ]*正[ ]*文[ ]*$";
		Zhongjistart = new String[]{"^[0-9]+\\.[0-9]+[ ]* 重大疾病的定|^第[一二三那四五六七八九十]+条[ ]*重大疾病定义|以上各种重大疾病应符合以下定义"};
		Zhongjiend = new String[]{"[0-9]+[ ]+申请与给付保险金|第[一二三那四五六七八九十]+条 [ ]*释义"};

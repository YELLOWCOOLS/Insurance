            ...
            <table id="datatable" class="table table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th class="col-9"><?php echo ($cp["cpname"]); ?>.<?php echo ($cp["name"]); ?>.病名释义</th>
                  <th class="col-1">按钮</th>
                </tr>
              </thead>
              <tbody>
                <?php if(is_array($illlist)): $i = 0; $__LIST__ = $illlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ill): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                  <!--   <a class="btn btn-xs btn-default" href="/admin/candidate/view/openid/<?php echo ($user["openid"]); ?>"><i class="fa fa-search"></i> </a>-->&nbsp;

                  <a class="btn btn-danger btn-xs" href="javascript:;" data-remove="<?php echo ($ill["num"]); ?>"><i class="fa fa-trash"></i></a></td>
